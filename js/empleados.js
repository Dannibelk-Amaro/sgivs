                    ...
                    (lee.mensaje || []).forEach(function(p, idx) {
                        filas += `<tr class='text-center'>
                            ...
                            <td class='align-middle' style='display: flex; justify-content: center;'>
                                <button type='button' class='btn-sm btn-primary w-50 small-width mb-1 bi bi-eye-fill' onclick='verDetalle(this)' title='Ver detalle' style='margin:.2rem; width: 40px !important;'></button>
                                <button type='button' class='btn-sm btn-info w-50 small-width mb-1 bi bi-arrow-repeat' onclick='pone(this,0)' title='Modificar rol' style='margin:.2rem; width: 40px !important;'></button>
                                <button type='button' class='btn-sm btn-danger w-50 small-width mt-1 bi bi-trash-fill' onclick='pone(this,1)' title='Eliminar rol' style='margin:.2rem; width: 40px !important;'></button>
                            </td>
                        </tr>`;
                    });
